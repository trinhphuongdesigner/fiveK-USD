...
module.exports = {
  ...
  async create(req, res) {
    try {
      ...
      const [
        ...
        foundPhoneNumber,
        foundAddress,
      ] = await Promise.all([getEmailExits, getPhoneExits, getAddressExits]);
  ...
  async remove(req, res) {
    try {
      ...
      const found = await Employee.findByIdAndDelete(id);
  ...
  async update(req, res) {
    try {
      ...
      const [
        foundEmail,
        foundPhoneNumber,
        foundAddress] = await Promise.all([getEmailExits, getPhoneExits, getAddressExits]);
